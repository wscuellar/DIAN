...
{
    public class TableLoggerManager : ITableManager
    {
        ...
        {
            var account = CloudStorageAccount.Parse(ConfigurationManager.GetValue("LogStorage"));
            var tableClient = account.CreateCloudTableClient();
            return tableClient;
        }

        public TableLoggerManager(string tableName, bool createIfNotExists = false)
        {            
        ...
        public TableLoggerManager(string tableName, string connectionString, bool createIfNotExists = false)
        {
