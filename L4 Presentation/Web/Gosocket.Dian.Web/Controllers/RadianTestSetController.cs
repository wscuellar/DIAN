    ...
    public class RadianTestSetController : Controller
    {
        ...
        public ActionResult Add(RadianTestSetViewModel model)
        {
            ...
            bool result = _radianTestSetService.InsertTestSet(new RadianTestSet(model.OperationModeId.ToString(), model.OperationModeId.ToString())
            {
                ...
                EndorsementProcurementTotalRequired = model.EndorsementTotalRequired,
                EndorsementProcurementTotalAcceptedRequired = model.EndorsementTotalAcceptedRequired,
                EndorsementGuaranteeTotalRequired = model.EndorsementTotalRequired,
                EndorsementGuaranteeTotalAcceptedRequired = model.EndorsementTotalAcceptedRequired,
