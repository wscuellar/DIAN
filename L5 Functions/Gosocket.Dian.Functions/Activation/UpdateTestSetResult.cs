        ...
        public static async Task Run([QueueTrigger(queueName, Connection = "GlobalStorage")] string myQueueItem, TraceWriter log)
        {
            ...
            {               
                ...
                if (radianTesSetResult != null && setResultOther == null)
                {
                    ...
                    if (radianTesSetResult.ReceiptNoticeRejected > (radianTesSetResult.ReceiptNoticeTotalRequired > 0 ? radianTesSetResult.ReceiptNoticeTotalRequired - radianTesSetResult.ReceiptNoticeTotalAcceptedRequired : radianTesSetResult.ReceiptNoticeTotalRequired)
                        || (radianTesSetResult.ReceiptServiceRejected > (radianTesSetResult.ReceiptServiceTotalRequired > 0 ? radianTesSetResult.ReceiptServiceTotalRequired - radianTesSetResult.ReceiptServiceTotalAcceptedRequired : radianTesSetResult.ReceiptServiceTotalRequired)) 
                        || (radianTesSetResult.ExpressAcceptanceRejected > (radianTesSetResult.ExpressAcceptanceTotalRequired > 0 ? radianTesSetResult.ExpressAcceptanceTotalRequired - radianTesSetResult.ExpressAcceptanceTotalAcceptedRequired : radianTesSetResult.ExpressAcceptanceTotalRequired))
                        || (radianTesSetResult.AutomaticAcceptanceRejected > (radianTesSetResult.AutomaticAcceptanceTotalRequired > 0 ? radianTesSetResult.AutomaticAcceptanceTotalRequired - radianTesSetResult.AutomaticAcceptanceTotalAcceptedRequired : radianTesSetResult.AutomaticAcceptanceTotalRequired))
                        || (radianTesSetResult.RejectInvoiceRejected > (radianTesSetResult.RejectInvoiceTotalRequired > 0 ? radianTesSetResult.RejectInvoiceTotalRequired - radianTesSetResult.RejectInvoiceTotalAcceptedRequired : radianTesSetResult.RejectInvoiceTotalRequired))
                        || (radianTesSetResult.ApplicationAvailableRejected > (radianTesSetResult.ApplicationAvailableTotalRequired > 0 ? radianTesSetResult.ApplicationAvailableTotalRequired - radianTesSetResult.ApplicationAvailableTotalAcceptedRequired : radianTesSetResult.ApplicationAvailableTotalRequired))
                        || (radianTesSetResult.EndorsementPropertyRejected > (radianTesSetResult.EndorsementPropertyTotalRequired > 0 ? radianTesSetResult.EndorsementPropertyTotalRequired - radianTesSetResult.EndorsementPropertyTotalAcceptedRequired : radianTesSetResult.EndorsementPropertyTotalRequired))
                        || (radianTesSetResult.EndorsementProcurementRejected > (radianTesSetResult.EndorsementProcurementTotalRequired > 0 ? radianTesSetResult.EndorsementProcurementTotalRequired - radianTesSetResult.EndorsementProcurementTotalAcceptedRequired : radianTesSetResult.EndorsementProcurementTotalRequired))
                        || (radianTesSetResult.EndorsementGuaranteeRejected > (radianTesSetResult.EndorsementGuaranteeTotalRequired > 0 ? radianTesSetResult.EndorsementGuaranteeTotalRequired - radianTesSetResult.EndorsementGuaranteeTotalAcceptedRequired : radianTesSetResult.EndorsementGuaranteeTotalRequired))
                        || (radianTesSetResult.EndorsementCancellationRejected > (radianTesSetResult.EndorsementCancellationTotalRequired > 0 ? radianTesSetResult.EndorsementCancellationTotalRequired - radianTesSetResult.EndorsementCancellationTotalAcceptedRequired : radianTesSetResult.EndorsementCancellationTotalRequired))
                        || (radianTesSetResult.GuaranteeRejected > (radianTesSetResult.GuaranteeTotalRequired > 0 ? radianTesSetResult.GuaranteeTotalRequired - radianTesSetResult.GuaranteeTotalAcceptedRequired : radianTesSetResult.GuaranteeTotalRequired))
                        || (radianTesSetResult.ElectronicMandateRejected > (radianTesSetResult.ElectronicMandateTotalRequired > 0 ? radianTesSetResult.ElectronicMandateTotalRequired - radianTesSetResult.ElectronicMandateTotalAcceptedRequired : radianTesSetResult.ElectronicMandateTotalRequired))
                        || (radianTesSetResult.EndMandateRejected > (radianTesSetResult.EndMandateTotalRequired > 0 ? radianTesSetResult.EndMandateTotalRequired - radianTesSetResult.EndMandateTotalAcceptedRequired : radianTesSetResult.EndMandateTotalRequired))
                        || (radianTesSetResult.PaymentNotificationRejected > (radianTesSetResult.PaymentNotificationTotalRequired > 0 ? radianTesSetResult.PaymentNotificationTotalRequired - radianTesSetResult.PaymentNotificationTotalAcceptedRequired : radianTesSetResult.PaymentNotificationTotalRequired))
                        || (radianTesSetResult.CirculationLimitationRejected > (radianTesSetResult.CirculationLimitationTotalRequired > 0 ? radianTesSetResult.CirculationLimitationTotalRequired - radianTesSetResult.CirculationLimitationTotalAcceptedRequired : radianTesSetResult.CirculationLimitationTotalRequired))
                        || (radianTesSetResult.EndCirculationLimitationRejected > (radianTesSetResult.EndCirculationLimitationTotalRequired > 0 ? radianTesSetResult.EndCirculationLimitationTotalRequired - radianTesSetResult.EndCirculationLimitationTotalAcceptedRequired : radianTesSetResult.EndCirculationLimitationTotalRequired))
                        || (radianTesSetResult.ReportForPaymentRejected > (radianTesSetResult.ReportForPaymentTotalRequired > 0 ? radianTesSetResult.ReportForPaymentTotalRequired - radianTesSetResult.ReportForPaymentTotalAcceptedRequired : radianTesSetResult.ReportForPaymentTotalRequired))                        
                        )
                    {
