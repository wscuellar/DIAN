...
namespace Gosocket.Dian.Functions.Global.Activation
{
        ...
        public static async Task<HttpResponseMessage> Run([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)]HttpRequestMessage req, TraceWriter log)
        {
            ...
            if (ConfigurationManager.GetValue("Environment") == "Hab")
            {
                ...
                try
                {
                    ...
                    //if (contributor.AcceptanceStatusId == (int)Domain.Common.ContributorStatus.Registered)
                    ...
                    foreach (var operation in operationModes.Where(o => !o.Deleted))
                    {
                        ...
                        if (testSetResult.Status != (int)Domain.Common.TestSetStatus.Accepted) continue;
