...
namespace Gosocket.Dian.Functions.Pdf
{
    public static class GetPdf
    {
        ...
        public static async Task<HttpResponseMessage> Run([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)] HttpRequestMessage req, TraceWriter log)
        {
            try
            {
                // Definir contenedor de par�metro
                ...
                {
                    {"documentTypeName", "Factura Electr�nica"},
                    {"accountAvatar", null},
                    {"isMontoPeriodo", "0"},
                    {"showRefButton", "0"},
                };
                ...
                // Obtener la Cadena para Construir el **C�DIGO QR**
                var dataToEncode = htmlGDoc.GetQRNote();

                // Construir Objeto Bitmap para C�digo QR - Convertir a Base 64 Image
                ...
                // Sustuir en el HTML la ruta de LOGO y C�DIGO QR para colocar im�genes
                ...
                // Sustituir en el HTML la respuesta de la validaci�n del documento y SigningTime
                ...
                // Salvar HTML como fichero f�sico en PC
