...
//            ViewResult result = _current.Index(registrationData) as ViewResult;
...
//            ViewResult result = _current.GetSetTestResult(radianApprovedViewModel) as ViewResult;
...
//            ViewResult result = _current.SetTestDetails(radianApprovedViewModel) as ViewResult;
...
//        {
//            ViewResult result = _current.ViewTestSet(id, radianTypeId, softwareId, softwareType) as ViewResult;
//            Assert.AreEqual("GetSetTestResult", result.ViewName);
//        }
