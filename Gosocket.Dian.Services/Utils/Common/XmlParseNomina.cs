...
namespace Gosocket.Dian.Services.Utils.Common
{
    public class XmlParseNomina
    {
        ...
        //            var novedadPath = "//*[local-name()='Novedad']";
        //            var paymentsDatesPath = "//*[local-name()='FechasPagos']";

        //            var tempNovedadXmlNode = xmlDocument.SelectSingleNode(novedadPath)?.InnerText;                
        ...
        //            XmlNodeList paymentsDatesList = xmlDocument.SelectSingleNode(paymentsDatesPath).SelectNodes("//*[local-name()='FechaPago']");
